package com.craftpg.domain.model.Character;
...
public class CharacterBase {
    ...
    public static CharacterBase create(final CreateCharacterBaseInput input) {
    ...
    public void update(final String name,
                       final String race,
                       final String clazz, final String attributesJson
    ) {
        this.name = name;
        this.race = race;
        this.clazz = clazz;
