...
public class CampaignInvite {
    ...
    public static CampaignInvite create(final UUID campaignId, final String email, final String tokenHash, final Set<CampaignRoleType> roles, final LocalDateTime expiresAt) {
    ...
    public void accept(final UUID userId) {
