...
public class CampaignCharacter {
    ...
    public static CampaignCharacter fromBase(final UUID campaignId, final UUID userId, final UUID characterBaseId) {
    ...
    public void updateSheet(final String sheetStateJson, final String inventoryJson) {
        this.sheetStateJson = sheetStateJson;
        this.inventoryJson = inventoryJson;
    }

    public void addXpAndApplyHappyPathLevelUp(final Integer gainedXp) {
        if (gainedXp < 0) {
